...
// client remove directory / file
  app.post('/directory/remove', function (req, res) {
    if (req.body.file) {
...
// client rename file
  app.post('/directory/rename', function (req, res) {
...
// client create directory
  app.post('/directory/mkdir', function (req, res) {
...
// client move directory
  app.post('/directory/mv', function (req, res) {
...
// lock api request
  app.get('/directory/lock', function (req, res) {
    if (req.query.f) {
...
// client get meida info
  app.get('/directory/info', function (req, res) {
