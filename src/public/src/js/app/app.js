requirejs(['../../bower_components/jquery/dist/jquery.min'], function () {
  requirejs(['format', '../../bower_components/notify.me/dist/js/notify-me', '../storage', '../../bower_components/jquery-ui/jquery-ui.min', '../popup/popup', '/src/bower_components/tablesorter/jquery.tablesorter.min.js'], function () {
